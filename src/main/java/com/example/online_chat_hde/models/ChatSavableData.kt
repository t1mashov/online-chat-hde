    ...
    companion object {
        fun fromJson(json: JSONObject): ChatSavableData {
            return ChatSavableData(
                userData = if (json.opt("userData") == JSONObject.NULL) null
                           else UserData.fromJson(json.getJSONObject("userData")),
                staffData = if (json.opt("staffData") == JSONObject.NULL) null
                ...
                startChatDatta = if (json.opt("startChatDatta") == JSONObject.NULL) null
